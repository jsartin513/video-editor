...
#   'round': 'Round 1',
#   'subround': 'first series', "start_seconds": 400, "video_file": "GX010494.MP4", "round_length_in_seconds": 1080}, 
#   {'away_team': 'Secret Lab Syndicate',
#   'court': 'court 2 ',
#   'home_team': 'Imaginary Friends',
#   'round': 'Round 1',
#   'subround': 'second series', "start_seconds":180, "video_file": "GX030494.MP4", "round_length_in_seconds": 1080},
...
#   'round': 'Quarters',
#   'subround': 'second series', "start_seconds": 180, "video_file": "GX010496.MP4", "round_length_in_seconds": 1080},
#  {'away_team': 'The Powerpuff Girls',
#   'court': 'court 2 ',
#   'home_team': 'Totally Spies',
#   'round': 'Quarters',
#   'subround': 'first series', "start_seconds": 180, "video_file": "GX010495.MP4", "round_length_in_seconds": 1080},
 {'away_team': 'Secret Lab Syndicate',
  'court': 'court 3 ',
...
#   'round': 'Semis',
#   'subround': None, "start_seconds": 1200, "video_file": "GX010351.MP4", "round_length_in_seconds": 1460},
 {'away_team': 'Dodge This, Mama',
  'court': 'court 2',
  'home_team': 'Totally Spies',
  'round': 'Finals',
  'subround': 'Championship', "start_seconds": 0, "video_file": "GX010352.MP4", "round_length_in_seconds": 1460},
...
COURT_2_DIRECTORY = "/Users/MrsHazmat/throw_down_3_recordings/court_2_playoffs_1"
...
if __name__ == "__main__":
    ...
    court_2_games = [game for game in GAMES if game["court"].lower().strip() == "court 2" and game.get("video_file", None) is not None]

    log(f"Court 3 games: {court_2_games}")

    create_playoff_game_videos(court_2_games, COURT_2_DIRECTORY)